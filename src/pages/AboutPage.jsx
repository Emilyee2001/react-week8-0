      ...
      <div className="container py-4 py-md-5 d-flex justify-content-center">
        <div className="col-md-8">
          ...
          <div className="ratio ratio-4x3 mb-4 mb-md-5">
            <img className="img-circle-fade" src="../src/assets/images/about01.png" alt="about01" />
          </div>
    ...
    <div className="container py-4 py-md-5">
      ...
      <div className="row mb-4 mb-md-5">
        <div className="col-md-6">
          <img className="img-circle-fade" src="../src/assets/images/about02.png" alt="about02" />
        </div>
      ...
      <div className="row flex-md-row-reverse">
        <div className="col-md-6">
          <img className="img-circle-fade" src="../src/assets/images/about03.png" alt="about03" />
        </div>
        <div className="col-md-6 my-auto">
